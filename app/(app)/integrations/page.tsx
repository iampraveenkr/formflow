...
export default function IntegrationsPage(): JSX.Element {
  ...
  return (
    <section className="space-y-4">
      ...
      <Card>
        <h2 className="text-lg font-semibold">OAuth consent and install flow</h2>
        <p className="mt-1 text-sm text-slate-600">During install, admins grant access only to scopes needed for configured actions.</p>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-xs text-slate-600">
          <li>Gmail send scope: send notifications from workflows.</li>
          <li>Sheets scope: append rows for lead and operations tracking.</li>
          <li>Calendar scope: schedule follow-up events.</li>
          <li>Drive/Docs scope: generate docs and exports when explicitly configured.</li>
        </ul>
      </Card>
